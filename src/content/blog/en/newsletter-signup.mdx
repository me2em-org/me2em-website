...
Use `cta-btn-brand` inside a `CTA` section and `hero-btn-brand` inside a band — `CtaBand` or `LetterGlitchBand`. Both give a brand-700 fill with white label text.
